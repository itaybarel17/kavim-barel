...
export const WaitingCustomersCounter: React.FC = () => {
  ...
  if (isLoading) {
    return <div className="flex items-center gap-2 text-blue-100 animate-pulse">
  ...
  if (totalCustomers === 0) {
    return <div className="flex items-center gap-4 bg-white/10 rounded-lg px-3 py-2 border border-white/20">
  ...
  return <div className="flex items-center gap-4 bg-white/10 rounded-lg py-2 border border-white/20 px-px">
      ...
      <div className="flex items-center gap-3">
        ...
        {!isKandi && regularCustomers > 0 && <div className="flex items-center gap-1 bg-blue-500/30 rounded px-2 py-1">
        ...
        {(isAdmin || isKandi) && kandiPlusCustomers > 0 && <div className="flex items-center gap-1 bg-blue-500/30 rounded px-2 py-1">
        ...
        {isAdmin && <div className="flex items-center gap-1 bg-white/20 rounded px-2 py-1">
